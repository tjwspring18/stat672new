...
def RunPermutationSimulation():
	...
	# 20 random permutations of data
	for i in range(0, 20):

		# list where we'll append cv error from each fit
		cv_fits = []
		...
		for f in fl:
			...
			# append 
			cv_fits.append(avg_err)

		# save minimum CV error for this permutation across all fits
		print(min(cv_fits))
	
#RunSimulation()
#TestModel()
RunPermutationSimulation()
